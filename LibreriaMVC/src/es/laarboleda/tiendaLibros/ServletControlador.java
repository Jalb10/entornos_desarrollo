...
public class ServletControlador extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextPage = "";
		String todo = request.getParameter("todo");//El ToDo esta en el name del form de la clase order 
		if (todo == null) {
		...
		else if (todo.equals("add")) // añadir libro al carrito
		{
			...
			ElementoPedido nuevoElementoPedido =
			new ElementoPedido(Integer.parseInt(request.getParameter("idLibro")),
